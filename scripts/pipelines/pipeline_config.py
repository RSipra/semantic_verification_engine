...
GENERATION_STRATEGY =[
    {
        ...
        "prompt_file": nb_cfg.PROMPTS_DIR / "explanatory_master_prompt.txt",
    ...
    },
    {
        ...
        "model_name": "gemini-2.5-pro",
        "prompt_file": nb_cfg.PROMPTS_DIR / "mcq_master_prompt.txt",
    ...
    },
    {
        ...
        "prompt_file": nb_cfg.PROMPTS_DIR / "factual_recall_master_prompt.txt",
