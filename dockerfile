...
# CPU-only wheel; pinned to 2.13.0 for CVE-2026-xxxxx (torch.jit.script). Not yet rebuilt as of 22 July 2026.
RUN pip install --no-cache-dir torch torch==2.13.0 --index-url https://download.pytorch.org/whl/cpu
